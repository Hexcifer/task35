...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .loader { display: none; width: 48px; height: 48px; border: 5px solid #FFF; border-bottom-color: #FF3D00; border-radius: 50%; display: block; margin: 16px auto; animation: rotation 1s linear infinite; }
